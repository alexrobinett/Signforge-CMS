...
export const { useGetPlayerPlaylistQuery } = playlistApiSlice;

export const selectPlayerPlaylistResult =
  playlistApiSlice.endpoints.getPlayerPlaylist.select();
...
export const { selectAll: selectAllPlaylist } = PlaylistAdapter.getSelectors(
  (state) => selectPlayerPlaylistData(state) ?? initialPlaylistState
);
